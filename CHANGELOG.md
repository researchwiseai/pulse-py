...
## [0.6.0](https://github.com/researchwiseai/pulse-py/compare/v0.5.0...v0.6.0) (2025-09-22)


### Features

* add async concurrent processing utilities ([a5fadd3](https://github.com/researchwiseai/pulse-py/commit/a5fadd30d3d404a3f0a768a89c622a7d7b99827e))
* add comprehensive Apache 2.0 compliance artifacts ([00190b4](https://github.com/researchwiseai/pulse-py/commit/00190b4c6b2473348ceb8d881dc5285976fd3815))
...
* add pre-release validation checks to GitHub Actions workflow ([d7c6773](https://github.com/researchwiseai/pulse-py/commit/d7c67730f703cb20a02563d9e1cd985acf9926d5))
...
* create streamlined release notes template ([cf93fbc](https://github.com/researchwiseai/pulse-py/commit/cf93fbc42368df8965f0ba67830e7f70a953d1a9))
...
* enhance sentiment analysis with parallel batching ([d56790c](https://github.com/researchwiseai/pulse-py/commit/d56790c0d390f48445a39e598c52fdcc38a40c2a))
...
* implement async authentication and client factory methods ([1a44351](https://github.com/researchwiseai/pulse-py/commit/1a443510275b87f21928fbe676d5f3a5c49fdade))
* implement async infrastructure and core HTTP client ([4783ea2](https://github.com/researchwiseai/pulse-py/commit/4783ea2f74be28b69b3495f369fc9b0fa5868e84))
* implement async starter functions ([e511c5c](https://github.com/researchwiseai/pulse-py/commit/e511c5c50d3be672eff22a05be4e078561c95175))
* implement AsyncAnalyzer for high-level async workflows ([58c88e7](https://github.com/researchwiseai/pulse-py/commit/58c88e7d6b3b5cc6b74e5fd7bb8f65c690585a58))
* implement AsyncCoreClient with all core API methods ([5767642](https://github.com/researchwiseai/pulse-py/commit/5767642ef92af493041f681a7cfc44596ce8098a))
* implement AsyncJob class with enhanced async capabilities ([1815593](https://github.com/researchwiseai/pulse-py/commit/1815593e22c82de80798999c1841a674f57f5bea))
* implement AsyncWorkflow DSL builder ([650a86a](https://github.com/researchwiseai/pulse-py/commit/650a86a3d46530ecd1b5a84e02dd777280f2fc7f))
...
* implement clustering intelligent parallel batching ([e635ab6](https://github.com/researchwiseai/pulse-py/commit/e635ab6181b9778de0c4d3a50ff039e0c3a58fe1))
* implement comprehensive async error handling and timeout patterns ([6d4547d](https://github.com/researchwiseai/pulse-py/commit/6d4547da892117099747493cbae36846f4e6b650))
...
* implement comprehensive error documentation system ([015a27f](https://github.com/researchwiseai/pulse-py/commit/015a27fba6cae7853fb7f64a881b6c44b5ba25d4))
...
* implement concurrent job management system for enhanced batching ([ec55678](https://github.com/researchwiseai/pulse-py/commit/ec55678a94bf7364504dd5c502e4df975be0badd))
* implement element extraction parallel batching ([bf729e6](https://github.com/researchwiseai/pulse-py/commit/bf729e6c54f3a1a9e9082cca04aab5f3ea770e92))
* implement parallel batching for slow mode embeddings ([80ff6d0](https://github.com/researchwiseai/pulse-py/commit/80ff6d045d742815b891fed7e82acb8737993f3a))
* remove compliance document attachment from releases ([f1deb66](https://github.com/researchwiseai/pulse-py/commit/f1deb6605a34cd0783580f55d5583e1e3c99a7df))
...
* streamline artifact upload configuration ([8702e95](https://github.com/researchwiseai/pulse-py/commit/8702e95c312dd143d4da66f7f5778936491011c7))
* streamline distribution signing to core artifacts only ([1d4d8ea](https://github.com/researchwiseai/pulse-py/commit/1d4d8eabba218adfe368a9068cfe139ee7ca69af))
...
* update validation system with enhanced batching limits and error handling ([06490a8](https://github.com/researchwiseai/pulse-py/commit/06490a82e17a6623d8fc46414a77bc7e91cf038c))
...
* add missing permissions and fix release configuration ([9303f39](https://github.com/researchwiseai/pulse-py/commit/9303f39c07dd18e5057e6e6c1a4fc437685ea78c))
...
* change fast parameter default from True to False across all layers ([8307e3f](https://github.com/researchwiseai/pulse-py/commit/8307e3f22de45d7f55a8e3ca4593f776e76db01f))
...
* remove deprecated license classifier from pyproject.toml ([1a8d7ee](https://github.com/researchwiseai/pulse-py/commit/1a8d7ee54f50e90932300db454b0d1249bda9743))
...
* add comprehensive batching support analysis report ([51c812c](https://github.com/researchwiseai/pulse-py/commit/51c812c0b66a5451c3bbfcc4421bc26d4855b092))
* complete task 12 - update documentation and create error reference guide ([cd10282](https://github.com/researchwiseai/pulse-py/commit/cd10282cb4d2f0197e77e39e1418b98037dcc9f9))
* fix remaining documentation syntax error ([bf4f6c3](https://github.com/researchwiseai/pulse-py/commit/bf4f6c3fee12deaa673452dd6582a5a8962a0f6c))
* update COMPLIANCE.md for streamlined release process ([89e07a9](https://github.com/researchwiseai/pulse-py/commit/89e07a95f2d65af70a8b99cbaffab3fbd5f3a487))
...
* Updated README ([06ab487](https://github.com/researchwiseai/pulse-py/commit/06ab4871a4d3d5b5c16e5fa79880bc56429e7228))
* Updated README around authentication ([80e4354](https://github.com/researchwiseai/pulse-py/commit/80e4354d4c1a05c0d06b96dbbbeaec4f9602b857))
...
* update compliance artifact generation for streamlined releases ([c94b186](https://github.com/researchwiseai/pulse-py/commit/c94b186a9e5cddc459720b52dd3fc71242f9b668))
...
## [0.5.0](https://github.com/researchwiseai/pulse-py/compare/v0.4.1...v0.5.0) (2025-09-21)
